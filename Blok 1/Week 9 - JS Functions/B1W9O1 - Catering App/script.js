...
let noData = () => document.getElementById('output').innerHTML = 'You canceled.<br>Have a nice day!';
...
setTimeout(() => {
    if(confirm('Welcome to café The Lukewarm Croquette!')) {
        validateOrder(); // Start asking for orders
    } else canceled();
}, 500);